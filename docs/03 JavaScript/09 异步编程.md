...
![img](https://gitee.com/ljcdzh/my_pic/raw/master/img/202203191256191.webp) func1的运行结果其实就是一个Promise对象。因此也可以使用then来处理后续逻辑。
...
![img](https://gitee.com/ljcdzh/my_pic/raw/master/img/202203191256131.webp)
