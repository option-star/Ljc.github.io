...
​	函数执行的时候，有一个预编译的过程，当遇到let\const会放到词法环境中，其初始值都是未初始化状态，未赋值访问会报错，当遇到var声明的变量会放到变量环境中，其初始值是undefined，可直接访问。

​	如果是在全局上下文中执行，var声明的变量会放到GO对象（window）中， 而let和const声明的变量则不会。
...
### （8）不能用作Generator函数，不能使用yeild关键字
...
最终，a、b、c分别被赋予了数组第0、1、2个索引位的值：
 ...
 <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e55fc36b191340e69698782fbd67ef4f~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp" alt="img" style="zoom: 50%;" /> 
...
通过把中间位留空，可以顺利地把数组第一位和最后一位的值赋给 a、c 两个变量
 ...
 <img src="https://gitee.com/ljcdzh/my_pic/raw/master/img/202203191052040.webp" alt="img" style="zoom: 50%;" />
...
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1ed2565845f2415b8243c8c355b2c6d6~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp" alt="img" style="zoom:50%;" />
