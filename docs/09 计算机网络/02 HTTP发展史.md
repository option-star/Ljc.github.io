...
![preview](https://cdn.jsdelivr.net/gh/option-star/imgs/202204070917103.jpeg)
...
![图片描述](https://cdn.jsdelivr.net/gh/option-star/imgs/202204070917927.webp) 
...
​	HTTP/2.0 通过 gzip 和 compress 压缩头部然后再发送，在客户端和服务端之间使用“首部表”来跟踪和存储之前发送的键值对，首部表在连接过程中始终存在，新增的键值对会更新到表尾，因比，避免了重复头部的传输，又减小了需要传输的大小。
