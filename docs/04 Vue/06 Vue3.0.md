...
## 6. Vue2.0和Vue3.0的生命周期有什么区别？

> vue3生命周期钩子

![img](https://gitee.com/ljcdzh/my_pic/raw/master/img/202203241209194.webp)

-  **新增`setup`**: setup执行时机是在beforeCreate之前执行，替代`beforeCreate`和`create`
- **`beforeDestroy`变成`beforeUnmount`和`dstroyed`变成`ummounted`**， 为了更加语义化
- **钩子命名都增加了`on`**
- 新增调试的钩子函数`onRenderTriggered`和`onRenderTricked`， 用于调试



> 区别图示

![img](https://gitee.com/ljcdzh/my_pic/raw/master/img/202203241214077.webp)
